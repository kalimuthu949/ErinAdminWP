...
const WFQuoteForm = (props) => {
  ...
  useEffect(() => {
    if (renderTaxesInfo) {
      objTaxes.Total.PreTax = ((isNaN(parseInt(objTaxes.Product.PreTax))?0:parseInt(objTaxes.Product.PreTax))+(isNaN(parseInt(objTaxes.Labour.PreTax))?0:parseInt(objTaxes.Labour.PreTax))+(isNaN(parseInt(objTaxes.ProductSubTotal.PreTax))?0:parseInt(objTaxes.ProductSubTotal.PreTax))+(isNaN(parseInt(objTaxes.DemoProduct.PreTax))?0:parseInt(objTaxes.DemoProduct.PreTax))+
      (isNaN(parseInt(objTaxes.DemoLabour.PreTax))?0:parseInt(objTaxes.DemoLabour.PreTax))+(isNaN(parseInt(objTaxes.DemoSubTotal.PreTax))?0:parseInt(objTaxes.DemoSubTotal.PreTax))+(isNaN(parseInt(objTaxes.Freight.PreTax))?0:parseInt(objTaxes.Freight.PreTax))+(isNaN(parseInt(objTaxes.SpringHandling.PreTax))?0:parseInt(objTaxes.SpringHandling.PreTax))+(isNaN(parseInt(objTaxes.ProfitOH.PreTax))?0:parseInt(objTaxes.ProfitOH.PreTax))+(isNaN(parseInt(objTaxes.Insurance.PreTax))?0:parseInt(objTaxes.Insurance.PreTax))).toString();

      objTaxes.Total.Tax = ((isNaN(parseInt(objTaxes.Product.Tax))?0:parseInt(objTaxes.Product.Tax))+(isNaN(parseInt(objTaxes.Labour.Tax))?0:parseInt(objTaxes.Labour.Tax))+(isNaN(parseInt(objTaxes.ProductSubTotal.Tax))?0:parseInt(objTaxes.ProductSubTotal.Tax))+(isNaN(parseInt(objTaxes.DemoProduct.Tax))?0:parseInt(objTaxes.DemoProduct.Tax))+
      (isNaN(parseInt(objTaxes.DemoLabour.Tax))?0:parseInt(objTaxes.DemoLabour.Tax))+(isNaN(parseInt(objTaxes.DemoSubTotal.Tax))?0:parseInt(objTaxes.DemoSubTotal.Tax))+(isNaN(parseInt(objTaxes.Freight.Tax))?0:parseInt(objTaxes.Freight.Tax))+(isNaN(parseInt(objTaxes.SpringHandling.Tax))?0:parseInt(objTaxes.SpringHandling.Tax))+(isNaN(parseInt(objTaxes.ProfitOH.Tax))?0:parseInt(objTaxes.ProfitOH.Tax))+(isNaN(parseInt(objTaxes.Insurance.Tax))?0:parseInt(objTaxes.Insurance.Tax))).toString();

      objTaxes.Total.Total = ((isNaN(parseInt(objTaxes.Product.Total))?0:parseInt(objTaxes.Product.Total))+(isNaN(parseInt(objTaxes.Labour.Total))?0:parseInt(objTaxes.Labour.Total))+(isNaN(parseInt(objTaxes.ProductSubTotal.Total))?0:parseInt(objTaxes.ProductSubTotal.Total))+(isNaN(parseInt(objTaxes.DemoProduct.Total))?0:parseInt(objTaxes.DemoProduct.Total))+
      (isNaN(parseInt(objTaxes.DemoLabour.Total))?0:parseInt(objTaxes.DemoLabour.Total))+(isNaN(parseInt(objTaxes.DemoSubTotal.Total))?0:parseInt(objTaxes.DemoSubTotal.Total))+(isNaN(parseInt(objTaxes.Freight.Total))?0:parseInt(objTaxes.Freight.Total))+(isNaN(parseInt(objTaxes.SpringHandling.Total))?0:parseInt(objTaxes.SpringHandling.Total))+(isNaN(parseInt(objTaxes.ProfitOH.Total))?0:parseInt(objTaxes.ProfitOH.Total))+(isNaN(parseInt(objTaxes.Insurance.Total))?0:parseInt(objTaxes.Insurance.Total))).toString();
              ...
              <td>
                <div style={{ width: "3rem", marginLeft: "auto" }}>
                  <TextField
                    ...
                    onChange={(e) => {
                      objProjInfo.InstallTotalHoursPerPerson =
                        e.target["value"];
                      setRenderProjInfo(true);
                    }}
                  />
